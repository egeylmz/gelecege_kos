      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Kullanıcı bilgilerini gösteren bir bölüm (isteğe bağlı)
            Text(
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.hasError) {
                    ...
                    return const Center(child: Text('Aktiviteler yüklenirken bir hata oluştu.'));
                  }
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final String formattedDate = DateFormat('dd MMMM yyyy', 'tr_TR').format(date);
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          title: Text(
                            // 'distance' null gelirse diye kontrol eklemek daha güvenlidir.
